...
import com.wzxlq.kill.server.enums.SysConstant;
import com.wzxlq.kill.server.service.IKillService;
import com.wzxlq.kill.server.service.RabbitSenderService;
import com.wzxlq.kill.server.utils.RandomUtil;
import com.wzxlq.kill.server.utils.SnowFlake;
        ...
        if (itemKillSuccessMapper.countByKillUserId(killId, userId) <= 0) {
            ...
            if (cacheRes) {
                ...
                try {
                    ...
                    throw new Exception("还没到抢购日期或者已过了抢购时间或已被抢购完毕！");
                } finally {
